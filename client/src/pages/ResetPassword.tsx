...
const ResetPassword: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-[1.75rem] px-[2rem] pb-[1.656rem] box-border gap-[10.125rem] leading-[normal] tracking-[normal] text-left text-[0.875rem] text-gray font-gilroy mq450:gap-[2.5rem] mq975:gap-[5.063rem]">
      <img
