...
const SignUpClinicHospitalCl: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-[1.75rem] px-[2rem] pb-[1.656rem] box-border gap-[5.318rem] leading-[normal] tracking-[normal] text-left text-[0.875rem] text-gray font-gilroy mq450:gap-[1.313rem] mq975:gap-[2.688rem]">
      <img
...
export default SignUpClinicHospitalCl;
