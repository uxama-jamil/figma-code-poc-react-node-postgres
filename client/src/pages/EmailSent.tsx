...
const EmailSent: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-[1.75rem] px-[2rem] pb-[1.656rem] box-border gap-[11.518rem] leading-[normal] tracking-[normal] mq450:gap-[2.875rem] mq975:gap-[5.75rem]">
      <img
